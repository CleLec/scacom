...
apa_table(
  ...
  align = "lcccc",
  font_size = "small",
  note = "Cross-sectional age differences in skills  estimated from a linear model regressing $T_1$ skill level on age. The study period was three years in PIAAC-L and six years in NEPS. \"$SD$\" refers to change in the standard deviations of the respective skill at $T_1$. All estimates are pooled across the 10 (20) PVs." 
)
