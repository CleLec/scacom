...
For full transparency, the complete R code for the analyses and the manuscript is available from the first author's github repository at [blinded for review].

\newpage

# Ethics statement
All individuals involved in PIAAC-L and NEPS gave their written consent to participate in this study after they had been informed about the purposes of the project, the content covered by the questionnaire, and their right to revoke consent at any time. All data were processed in accordance with the pertinent data protection rules in order to ensure the anonymity of participants. For more information, see the project websites of NEPS and PIAAC-L.
